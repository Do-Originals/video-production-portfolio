...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex min-h-[55vh] md:min-h-[75vh] flex-col items-center justify-center overflow-hidden bg-slate-950 w-full z-0 pt-12 md:pt-24",
        className
      )}
    >
      ...
      <div className="relative z-50 flex -translate-y-12 md:-translate-y-24 flex-col items-center px-5">
        {children}
      </div>
    </div>
  );
